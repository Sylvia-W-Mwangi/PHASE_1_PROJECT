...
* This project analyzes a dataset from [Kaggle](kaggle.com/dataset/shijo96john/stress-level-prediction)
  containing employee data on age, occupation, lifestyle choices, health and stress levels.

* The goal is to investigate the relationships within the employee dataset in relation to the stress level:
    * Lifestyle choices and stress
    * Age, Health and stress
    * Occupation, Work-related factors and stress
